...
- Phase 4 的 14 个条目已全部在 `docs/phase-tasks.md` 标记 `[x]`；Phase 5 仍有 P5-14 子项未完成，README 不能把 Phase 5 写成整阶段完成。
